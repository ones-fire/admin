...
<div class="container-fluid">
                ...
                <div class="col mb-4">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <a class="btn btn-success" onclick="window.location.href = 'tgl_absen.php?kelas=<?= $_GET['kelas']; ?>';">
                                <span class="text">Tanggal:
                                    <span id="selectedDate"></span>
                                    <i id="calendarIcon" class="far fa-calendar"></i>
                                </span>
                            </a>
                            ...
                            <script>
                                ...
                                selectedDateElement.textContent = defaultDate;
                            </script>
                        ...
                        <div class="card-body">
                            <form method="post" action="../input/pro_absen.php">
                                ...
                                <input type="hidden" name="tanggal_hari_ini" value="<?= $tanggal_hari_ini; ?>">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col">No</th>
    ...
    if (isset($_GET['pesan'])) {
        ...
        if ($pesan == "success") {
            ...
            echo "<script>alert('Absensi untuk tanggal $tanggal_get sudah ada, untuk mengedit data tekan tombol Tanggal')</script>";
        }
    }
    ?>
